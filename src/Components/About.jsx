...
const About = () => {
    return (
        <div className="about mb-4 flex justify-center bg-slate-300">
            <div className="about-container flex flex-col p-5 m-5 bg-sky-200 rounded-md items-center justify-center w-4/5 h-screen shadow-xl">
                <div className='flex justify-center font-extrabold text-4xl m-10 text-green-700 '>
                    <p className="main-text-2">Welcome to RoxWealth</p>
                </div>
